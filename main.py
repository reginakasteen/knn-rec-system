...
model_knn = NearestNeighbors(metric='euclidean', algorithm='ball_tree', n_neighbors=10)
...
hotel_recommender('Bo Phut Resort and Spa - SHA Plus', mat_hotels_users, model_knn,10)